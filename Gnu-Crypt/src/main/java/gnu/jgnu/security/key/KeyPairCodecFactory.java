...
import gnu.jgnu.security.util.FormatUtil;
...
public class KeyPairCodecFactory
{
    ...
    /**
     * Returns the appropriate codec given a composed key-pair generator
     * algorithm and an encoding format. A composed name is formed by the
     * concatenation of the canonical key-pair algorithm name, the forward slash
     * character <code>/</code> and the canonical name of the encoding format.
     * <p>
     * <b>IMPORTANT</b>: For backward compatibility, when the encoding format
     * name is missing, the Raw encoding format is assumed. When this is the
     * case the trailing forward slash is discarded from the name.
     *
     * @param name
     ...
     * @return the PKCS#8 codec corresponding to the key, or <code>null</code>

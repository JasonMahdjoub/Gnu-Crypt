...
import gnu.jgnu.security.action.GetSecurityPropertyAction;
import gnu.jgnu.security.prng.LimitReachedException;
import gnu.jgnu.security.prng.MDGenerator;
import gnu.vm.jgnu.security.SecureRandom;
import gnu.vm.jgnu.security.SecureRandomSpi;

/**
 * <p>
 * The implementation of a generic {@link gnu.vm.jgnu.security.SecureRandom}
 * adapter class to wrap gnu.crypto prng instances based on Message Digest
 * algorithms.
 * </p>
 *
 * <p>
 * This class defines the <i>Service Provider Interface</i> (<b>SPI</b>) for the
 * {@link gnu.vm.jgnu.security.SecureRandom} class, which provides the

...
import gnu.jgnu.security.key.KeyPairGeneratorFactory;
...
/**
 * The implementation of a generic {@link gnu.vm.jgnu.security.KeyPairGenerator}
 * adapter class to wrap GNU keypair generator instances.
 * <p>
 * This class defines the <i>Service Provider Interface</i> (<b>SPI</b>) for the
 * {@link gnu.vm.jgnu.security.KeyPairGenerator} class, which is used to
 * generate pairs of public and private keys.
 * <p>
 * All the abstract methods in the
 * {@link gnu.vm.jgnu.security.KeyPairGeneratorSpi} class are implemented by

...
public interface ISignature extends Cloneable {
	...
	/**
	 * Property name of an optional {@link gnu.vm.jgnu.security.SecureRandom},
	 * {@link java.util.Random}, or {@link gnu.jgnu.security.prng.IRandom} instance
	 * to use. The default is to use a classloader singleton from
	 * {@link gnu.jgnu.security.util.PRNG}.
	 */

...
import gnu.jgnu.security.sig.dss.DSSSignature;
import gnu.jgnu.security.sig.rsa.RSASignatureFactory;
...
public class SignatureFactory
{
	...
	if (ssa.equalsIgnoreCase(Registry.DSA_SIG)
		|| ssa.equals(Registry.DSS_SIG))

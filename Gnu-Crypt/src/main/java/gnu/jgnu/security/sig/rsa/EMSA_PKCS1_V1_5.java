...
package gnu.jgnu.security.sig.rsa;

import java.io.ByteArrayOutputStream;

import gnu.jgnu.security.Registry;
import gnu.jgnu.security.hash.HashFactory;
import gnu.jgnu.security.hash.IMessageDigest;

/**
 * An implementation of the EMSA-PKCS1-V1.5 encoding scheme.
 * <p>
 * EMSA-PKCS1-V1.5 is parameterised by the choice of hash function Hash and hLen
 * which denotes the length in octets of the hash function output.
 * <p>
 * References:
 * <ol>
...
public class EMSA_PKCS1_V1_5 implements Cloneable {
	/*
	 * Notes. 1. For the six hash functions mentioned in Appendix B.1, the DER
	 * encoding T of the DigestInfo value is equal to the following:
	 * 
	 * MD2: (0x)30 20 30 0c 06 08 2a 86 48 86 f7 0d 02 02 05 00 04 10 || H MD5:
	 * (0x)30 20 30 0c 06 08 2a 86 48 86 f7 0d 02 05 05 00 04 10 || H SHA-1: (0x)30
	 * 21 30 09 06 05 2b 0e 03 02 1a 05 00 04 14 || H SHA-256: (0x)30 31 30 0d 06 09
	 * 60 86 48 01 65 03 04 02 01 05 00 04 20 || H SHA-384: (0x)30 41 30 0d 06 09 60
	 * 86 48 01 65 03 04 02 02 05 00 04 30 || H SHA-512: (0x)30 51 30 0d 06 09 60 86
	 * 48 01 65 03 04 02 03 05 00 04 40 || H
	 */
	private static final byte[] MD2_PREFIX = { (byte) 0x30, (byte) 0x20, (byte) 0x30, (byte) 0x0c, (byte) 0x06,
			(byte) 0x08, (byte) 0x2a, (byte) 0x86, (byte) 0x48, (byte) 0x86, (byte) 0xf7, (byte) 0x0d, (byte) 0x02,
			(byte) 0x02, (byte) 0x05, (byte) 0x00, (byte) 0x04, (byte) 0x10 };

	private static final byte[] MD5_PREFIX = { (byte) 0x30, (byte) 0x20, (byte) 0x30, (byte) 0x0c, (byte) 0x06,
			(byte) 0x08, (byte) 0x2a, (byte) 0x86, (byte) 0x48, (byte) 0x86, (byte) 0xf7, (byte) 0x0d, (byte) 0x02,
			(byte) 0x05, (byte) 0x05, (byte) 0x00, (byte) 0x04, (byte) 0x10 };

	private static final byte[] SHA160_PREFIX = { (byte) 0x30, (byte) 0x21, (byte) 0x30, (byte) 0x09, (byte) 0x06,
			(byte) 0x05, (byte) 0x2b, (byte) 0x0e, (byte) 0x03, (byte) 0x02, (byte) 0x1a, (byte) 0x05, (byte) 0x00,
			(byte) 0x04, (byte) 0x14 };

	private static final byte[] SHA256_PREFIX = { (byte) 0x30, (byte) 0x31, (byte) 0x30, (byte) 0x0d, (byte) 0x06,
	...
	private static final byte[] SHA384_PREFIX = { (byte) 0x30, (byte) 0x41, (byte) 0x30, (byte) 0x0d, (byte) 0x06,
			(byte) 0x09, (byte) 0x60, (byte) 0x86, (byte) 0x48, (byte) 0x01, (byte) 0x65, (byte) 0x03, (byte) 0x04,
			(byte) 0x02, (byte) 0x02, (byte) 0x05, (byte) 0x00, (byte) 0x04, (byte) 0x30 };

	private static final byte[] SHA512_PREFIX = { (byte) 0x30, (byte) 0x51, (byte) 0x30, (byte) 0x0d, (byte) 0x06,
			(byte) 0x09, (byte) 0x60, (byte) 0x86, (byte) 0x48, (byte) 0x01, (byte) 0x65, (byte) 0x03, (byte) 0x04,
	 ...
	 *             if the hash function is not implemented or does not have an ID
	 *             listed in RFC-3447.
	 */
	public static final EMSA_PKCS1_V1_5 getInstance(final String mdName) {
		...
		if (!(name.equals(Registry.MD2_HASH) || name.equals(Registry.MD5_HASH) || name.equals(Registry.SHA160_HASH)
				|| name.equals(Registry.SHA256_HASH) || name.equals(Registry.SHA384_HASH)
	 ...
	 *
	 * @param hash
	 *            the message digest instance to use with this scheme instance.
	 */
	...
	/**
	 * Frames the hash of a message, along with an ID of the hash function in a DER
	 * sequence according to the specifications of EMSA-PKCS1-V1.5 as described in
	 * RFC-3447 (see class documentation).
	 *
	 * @param mHash
	 ...
	 *            <code>tLen + 11</code>, where <code>tLen</code> is the octet
	 *            length of the DER encoding <code>T</code> of a certain value
	 *            computed during the encoding operation.
	 * @return encoded message, an octet string of length <code>emLen</code>.
	 * @throws IllegalArgumentException
	 *             if the message is too long, or if the intended encoded message
	 *             length is too short.
	 */

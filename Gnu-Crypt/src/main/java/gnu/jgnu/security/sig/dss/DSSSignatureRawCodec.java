...
public class DSSSignatureRawCodec implements ISignatureCodec
{
     ...
     * Standard) signature object according to the <i>Raw</i> format supported
     * by this library.
     * <p>
     ...
     * the <code>toByteArray()</code> method on the DSS parameter
     * <code>r</code>,</li>
     * <li>4-byte count of following bytes representing the DSS parameter
     * <code>s</code>,</li>
     * <li>n-bytes representation of a {@link BigInteger} obtained by invoking
     ...
     *            <code>r</code> and <code>s</code> as a {@link BigInteger}
     *            array.
     * @return the <i>Raw</i> format encoding of the designated signature.
     * @exception IllegalArgumentException
     *                if the designated signature is not a DSS (Digital
     *                Signature Standard) one.
     */
    @Override

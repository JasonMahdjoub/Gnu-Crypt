...
public class RSA
{
     ...
     *             if <code>c</code>, the ciphertext representative is not
     *             between <code>0</code> and <code>n - 1</code> (<code>n</code>
     ...
     *             <code>0</code> and <code>n - 1</code> (<code>n</code> being
     ...
     *                if the length in octets of meaningful bytes of
     *                <code>s</code> is greater than <code>k</code>.
     */
	...
	if (result.length < k)
	{
	    ...
	    System.arraycopy(result, 0, newResult, k - result.length,
		    result.length);
	    result = newResult;
	}
    ...
    /**
     * Returns a random MPI with a random bit-length of the form
     * <code>8b</code>, where <code>b</code> is in the range
     * <code>[32..64]</code>.
     *
     * @return a random MPI whose length in bytes is between 32 and 64
     *         inclusive.
     */
    ...
    /**
     * An implementation of the <b>RSASP</b> method: Assuming that the
     ...
     *            <code>0</code> and <code>n - 1</code>, where <code>n</code> is
     *            the RSA <i>modulus</i>.
     ...
     *             if <code>K</code> is not an RSA one.
     * @throws IllegalArgumentException
     *             if <code>m</code> (the <i>message representative</i>) is out
     *             of range.
     */
    ...
    /**
     * An implementation of the <b>RSAVP</b> method: Assuming that the
     ...
     *            <code>0</code> and <code>n - 1</code>, where <code>n</code> is
     *            the RSA <i>modulus</i>.
     * @return a <i>message representative</i>: an integer between
     *         <code>0</code> and <code>n - 1</code>, where <code>n</code> is
     *         the RSA <i>modulus</i>.
     * @throws ClassCastException
     *             if <code>K</code> is not an RSA one.
     * @throws IllegalArgumentException
     *             if <code>s</code> (the <i>signature representative</i>) is
     *             out of range.
     */

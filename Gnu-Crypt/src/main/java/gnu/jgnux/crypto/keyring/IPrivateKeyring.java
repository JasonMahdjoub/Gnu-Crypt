...
public interface IPrivateKeyring extends IKeyring
{
     ...
     *         with the given <code>alias</code>; <code>false</code> otherwise.
     */
     ...
     *
     * @param alias
     *            The alias of the private key to find.
     * @param password
     *            The password of the private key.
     * @return The private, or secret, key if one is found; <code>null</code> if
     *         none were found.
     * @throws UnrecoverableKeyException
     *             If the private key could not be recovered, possibly due to a
     *             bad password.
     */

...
public final class AuthenticatedEntry extends MaskableEnvelopeEntry implements Registry
{
	...
	if (mac == null)
	    throw new IllegalArgumentException(
		    "no such mac: " + properties.get("mac"));
	int maclen = 0;
    ...
    /**
     * Verifies this entry's payload. This method will unmask this entry, thus
     * it must be called before accessing its contents.
     *
     * @param key
	...
	try
	{
	    ...
	    ByteArrayInputStream bais = new ByteArrayInputStream(payload, 0,
		    len);

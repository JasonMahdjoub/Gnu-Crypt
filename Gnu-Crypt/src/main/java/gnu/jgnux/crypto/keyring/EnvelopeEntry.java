...
public abstract class EnvelopeEntry extends Entry
{
     ...
     * masked entries that contain the given alias, they will be returned as
     * well.
     *
     * @param alias
    ...
    /**
     * Returns the list of all aliases contained by this envelope, separated by
     * a semicolon (';').
     *
    ...
    {
	return new StringBuilder("Envelope{").append(super.toString())
		.append(", entries=").append(entries).append("}").toString();
    }
}

...
{
    private static final String[] TYPES = new String[] { "Encrypted",
	    "PasswordEncrypted", "Authenticated", "PasswordAuthenticated",
    ...
    /**
     * Generic decoding method, which simply decodes the properties field and
     * reads the payload field.
     *
     * @param in
    ...
    {
	return new StringBuilder("Entry{").append("type=").append(TYPES[type])
		.append(", properties=").append(properties).append(", payload=")

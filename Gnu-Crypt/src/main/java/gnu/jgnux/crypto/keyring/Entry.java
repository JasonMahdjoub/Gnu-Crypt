...
public abstract class Entry {
	private static final String[] TYPES = new String[] { "Encrypted", "PasswordEncrypted", "Authenticated",
			"PasswordAuthenticated", "Compressed", "Certificate", "PublicKey", "PrivateKey", "CertPath", "BinaryData" };
	 ...
	 *             If the properties argument is null, or if the type is out of
	 *             range.
	 */
	...
	/**
	 * Generic decoding method, which simply decodes the properties field and reads
	 * the payload field.
	 *
	 * @param in
	...
	public String toString() {
		return new StringBuilder("Entry{").append("type=").append(TYPES[type]).append(", properties=")
				.append(properties).append(", payload=").append(payload == null ? "-" : "byte[" + payload.length + "]")
				.append("}").toString();
	}
}

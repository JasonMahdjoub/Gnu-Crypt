...
public interface IKeyring
{
     ...
     *         {@link Entry} can be found with the designated
     *         <code>alias</code>.
     */
     ...
     *
     * @param attributes
     *            The attributes that designate the source where the store is to
     *            be loaded from. What happens
     ...
     *
     * @param attributes
     *            the attributes that define where the contents of this keyring
     *            will be stored.
     * @throws IOException

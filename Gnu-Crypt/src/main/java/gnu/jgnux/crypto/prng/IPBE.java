...
public interface IPBE
{
    ...
    /**
     * Property name for the password in a PBE algorithm. The property
     * associated with this is expected to be a char array.
     */
     ...
     * used, then {@link #DEFAULT_PASSWORD_ENCODING} will be used when
     * converting the password character(s) to bytes.
     */
     ...
     * to be used as the source for a PBE-based Key Derivation Function (KDF)
     * and (b) no character set encoding name was specified among the attributes

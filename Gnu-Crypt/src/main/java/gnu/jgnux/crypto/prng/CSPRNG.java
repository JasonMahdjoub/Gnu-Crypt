...
import gnu.jgnu.security.prng.BasePRNG;
import gnu.jgnu.security.prng.EntropySource;
import gnu.jgnu.security.prng.IRandom;
import gnu.jgnu.security.prng.LimitReachedException;
import gnu.jgnu.security.util.SimpleList;
...
public class CSPRNG extends BasePRNG
{
     ...
     * </ol>
     *
     * @see gnu.jgnu.security.util.SimpleList
     */
    ...
    /**
     * Property name for a list of other sources of entropy. The mapped value
     * must be a list of {@link EntropySource} objects.
     */
     ...
     * randomness (in addition to the current time and the amount of free
     * memory) based on the randomness (if any) present due to system load and
     * thread scheduling.
     */
     ...
     * instance are derived from properties set in the system
     * {@link Properties}.
     * <p>
     ...
     * <dd>
     * <p>
     * These properties are program sources, passed as the
     * {@link #PROGRAM_SOURCES} parameter of the instance. This property is
     * formatted the same way as file and URL sources, but the last argument is
     ...
     * class that implements the {@link EntropySource} interface and has a
     ...
     *             If <i>off</i> or <i>len</i> are out of the range of
     *             <i>buf</i>.
     */
    @Override
     ...
     * random pool, hash that block, the previous 20 bytes, and the next 44
     * bytes with SHA-1, writing the result back into that block.
     */

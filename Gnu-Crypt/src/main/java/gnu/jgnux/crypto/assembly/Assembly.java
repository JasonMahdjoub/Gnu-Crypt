...
public class Assembly
{
    ...
    /**
     * Adds the designated {@link Transformer} and signals that it should
     * operate in post-processing mode; i.e. it should apply its internal
     * transformation algorithm on the input data stream, <b>after</b> it passes
     * that stream to the next element in the <i>chain</i>.
     *
     * @param t
     *            the {@link Transformer} to add at the head of the current
     *            chain.
     * @throws IllegalArgumentException
     *             if the designated {@link Transformer} has a non-null tail;
     *             i.e. it is already an element of a chain.
     */
    ...
    /**
     * Adds the designated {@link Transformer} and signals that it should
     * operate in pre-processing mode; i.e. it should apply its internal
     * transformation algorithm on the input data stream, <b>before</b> it
     * passes that stream to the next element in the <i>chain</i>.
     *
     * @param t
     *            the {@link Transformer} to add at the head of the current
     *            chain.
     ...
     * signals, at the same time, that this is the last <i>push</i> operation
     * for this <code>Assembly</code>.
     *
     * @param in
     *            the input data bytes.
     * @param offset

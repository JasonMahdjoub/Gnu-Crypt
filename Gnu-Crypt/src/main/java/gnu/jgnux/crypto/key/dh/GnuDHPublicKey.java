...
public class GnuDHPublicKey extends GnuDHKey implements DHPublicKey
{
     ...
     * <code>encodePublicKey()</code> method of a DH keypair codec object (an
	...
	if (k[0] == Registry.MAGIC_RAW_DH_PUBLIC_KEY[0])
	    try
	    {
		return (GnuDHPublicKey) new DHKeyPairRawCodec()
			.decodePublicKey(k);
	    }
	...
	super(preferredFormat == Registry.ASN1_ENCODING_ID
		? Registry.X509_ENCODING_ID : preferredFormat, q, p, g);
	this.y = y;
    }

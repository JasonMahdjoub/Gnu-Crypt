...
public class KeyAgreementException extends KeyManagementException implements Serializable
{
     ...
     * nonexistent or unknown. The <i>cause</i> is the throwable that caused
     ...
     * messsage, and if it has a <i>root</i> exception, the string
     * representation of the root exception. This string representation is meant

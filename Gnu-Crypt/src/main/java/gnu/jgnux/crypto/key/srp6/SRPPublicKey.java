...
public class SRPPublicKey extends SRPKey implements PublicKey
{
     ...
     * 
     */
    private static final long serialVersionUID = -1435792833357253314L;

    /**
     * A class method that takes the output of the
     * <code>encodePublicKey()</code> method of an SRP keypair codec object (an
     * instance implementing {@link IKeyPairCodec} for SRP keys, and
     ...
     *
     * @param params
     *            an array of 3 values representing N, g and Y; the latter being

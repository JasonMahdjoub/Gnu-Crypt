...
public class IncomingMessage
{
	...
	if (result > Registry.SASL_FOUR_BYTE_MAX_LIMIT || result < 0)
	    throw new KeyAgreementException(
		    "encoded entity size limit exceeded");
	return result;
    }
	...
	switch (formatID)
	{
		...
		switch (keyType)
		{
		    ...
		    default:
			throw new KeyAgreementException(
				"Unknown key-type for Raw format: " + keyType);
		}
		...
		switch (keyType)
		{
		    ...
		    default:
			throw new KeyAgreementException(
				"Unknown key-type for X.509 format: "
					+ keyType);
		}
		...
		switch (keyType)
		{
		    ...
		    default:
			throw new KeyAgreementException(
				"Unknown key-type for PKCS#8 format: "
					+ keyType);
		}
	    default:
		throw new KeyAgreementException(
			"Unknown format identifier: " + formatID);
	}
    }
     ...
     * <p>
     * See
     * {@link OutgoingMessage#writePrivateKey(gnu.vm.jgnu.security.PrivateKey)}
     * for more details.
     *
     * @throws KeyAgreementException
     ...
     * <p>
     * See
     * {@link OutgoingMessage#writePublicKey(gnu.vm.jgnu.security.PublicKey)}

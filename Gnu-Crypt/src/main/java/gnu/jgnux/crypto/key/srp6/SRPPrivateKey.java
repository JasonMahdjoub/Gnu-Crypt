...
public class SRPPrivateKey extends SRPKey implements PrivateKey
{
     ...
     * <code>encodePrivateKey()</code> method of an SRP keypair codec object (an
     * instance implementing {@link IKeyPairCodec} for DSS keys, and
     ...
     *
     * @param params
     *            an array of either 3 or 4 values representing N, g, and either
     *            v and X for the server, or just X for the client. Those values
	...
	else if (params.length == 4)
	{
	    ...
	    throw new IllegalArgumentException(
		    "invalid number of SRP parameters");
    }

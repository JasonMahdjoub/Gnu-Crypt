...
public class SRPPrivateKey extends SRPKey implements PrivateKey {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2877587523881470307L;
	...
	public static SRPPrivateKey valueOf(byte[] k) {
		...
		// direct the byte array to the appropriate codec. since we only have
		// one
	 ...
	 * as g.modPow(x, N), where x is the hashed output of the user name and password
	 * .
	 */
	 ...
	 *
	 * @param params
	 *            an array of either 3 or 4 values representing N, g, and either v
	 *            and X for the server, or just X for the client. Those values
	 ...
	 * <code>SRPPrivateKey</code> and has the same SRP parameter values as this one.
	 *
	 * @param obj
	 ...
	 *
	 * @return the user's verifier as a {@link BigInteger} if this is an SRP private
	 *         key of a Host, or <code>null</code> if this is a private SRP key for
	 *         a User.
	 */

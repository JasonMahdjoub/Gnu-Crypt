...
public interface IKeyAgreementParty
{
     ...
     *             if the key agreement is not yet initialised, or is
     *             initialised but the exchange is still in progress.
     */
    ...
    /**
     * Processes an incoming message at one end, generating a message that will
     * be processed by the other party(ies).
     *
     * @param in

...
public class SRPKeyPairRawCodec implements IKeyPairCodec {
	...
	public PrivateKey decodePrivateKey(byte[] k) {
		// magic
		if (k[0] != Registry.MAGIC_RAW_SRP_PRIVATE_KEY[0] || k[1] != Registry.MAGIC_RAW_SRP_PRIVATE_KEY[1]
				|| k[2] != Registry.MAGIC_RAW_SRP_PRIVATE_KEY[2] || k[3] != Registry.MAGIC_RAW_SRP_PRIVATE_KEY[3])
	...
	public PublicKey decodePublicKey(byte[] k) {
		// magic
		if (k[0] != Registry.MAGIC_RAW_SRP_PUBLIC_KEY[0] || k[1] != Registry.MAGIC_RAW_SRP_PUBLIC_KEY[1]
				|| k[2] != Registry.MAGIC_RAW_SRP_PUBLIC_KEY[2] || k[3] != Registry.MAGIC_RAW_SRP_PUBLIC_KEY[3])
			throw new IllegalArgumentException("magic");
		// version
		if (k[4] != 0x01)
			throw new IllegalArgumentException("version");
	 ...
	 * <code>toByteArray()</code> method on the SRP parameter <code>N</code>,</li>
	 * <li>4-byte count of following bytes representing the SRP parameter
	 * <code>g</code>,</li>
	 * <li>n-bytes representation of a {@link BigInteger} obtained by invoking the
	 * <code>toByteArray()</code> method on the SRP parameter <code>g</code>,</li>
	 * <li>4-byte count of following bytes representing the SRP parameter
	 * <code>x</code>,</li>
	 * <li>n-bytes representation of a {@link BigInteger} obtained by invoking the
	 * <code>toByteArray()</code> method on the SRP parameter <code>x</code>,</li>
	 ...
	 * <code>v</code>,</li>
	 * <li>n-bytes representation of a {@link BigInteger} obtained by invoking the
	 * <code>toByteArray()</code> method on the SRP parameter <code>v</code>,</li>
	 * </ol>
	 *
	 * @param key
	 *            the key to encode.
	 ...
	 *             if the designated key is not an SRP one.
	 */
	@Override
	 ...
	 * <code>y</code>,</li>
	 * <li>n-bytes representation of a {@link BigInteger} obtained by invoking the
	 * <code>toByteArray()</code> method on the SRP parameter <code>y</code>,</li>
	 * </ol>
	 *
	 * @param key
	 *            the key to encode.

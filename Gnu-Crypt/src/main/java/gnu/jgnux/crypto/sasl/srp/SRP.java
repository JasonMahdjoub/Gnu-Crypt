...
public final class SRP
{
    ...
    {
	return computeX(s, user.getBytes("US-ASCII"),
     ...
     *             if the implementation of the message digest algorithm does
     *             not support cloning.
     */
     ...
     *         bytes from the designated arrays. N is the size of the SRP
     *         message digest algorithm; eg. 20 for SHA-160.
     */

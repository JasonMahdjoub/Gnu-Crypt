...
public final class Twofish extends BaseCipher
{
    ...
    private static final int OUTPUT_WHITEN = INPUT_WHITEN
	    + DEFAULT_BLOCK_SIZE / 4;

    private static final int ROUND_SUBKEYS = OUTPUT_WHITEN
	    + DEFAULT_BLOCK_SIZE / 4;
    ...
    private static final byte[] KAT_CT = Util
	    .toBytesFromString("F51410475B33FBD3DB2117B5C17C82D4");
	...
	for (i = 0; i < 256; i++)
	{
	    ...
	    mX[1] = Mx_X(j) & 0xFF;
	    mY[1] = Mx_Y(j) & 0xFF;
	    MDS[0][i] = m1[P_00] << 0 | mX[P_00] << 8 | mY[P_00] << 16
		    | mY[P_00] << 24;

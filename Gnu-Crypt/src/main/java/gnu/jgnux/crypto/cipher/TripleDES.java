...
public class TripleDES extends BaseCipher
{
     ...
     *
     * @param keyCount
     *            the number of independent DES keys. Can be either
     *            <code>1</code>, <code>2</code> or <code>3</code>. Any other
     *            value will cause an {@link IllegalArgumentException} to be
     *            raised.
     * @param kb
     *            the array containing the key bytes to adjust. MUST have at
     *            least <code>8 * keyCount</code> bytes starting at offset
     *            position <code>offset</code>, otherwise an
	...
	if (keyCount < 1 || keyCount > 3)
	    throw new IllegalArgumentException(
		    "Invalid keyCount value: " + keyCount);
	...
	if (kb.length != 8 && kb.length != 16 && kb.length != 24)
	    throw new InvalidKeyException(
		    "TripleDES key must be 8, 16 or 24 bytes: " + kb.length);

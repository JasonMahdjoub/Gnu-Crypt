...
public class SwingCallbackHandler extends AbstractCallbackHandler
{
	...
	content.add(buttons,
		new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1,
			1, GridBagConstraints.SOUTHEAST,
	...
	ChoiceCallback cb = new ChoiceCallback(
		messages.getString("callback.language"), localeNames, 0, false);
	handleChoice(cb);
	...
	content.add(new JLabel(callback.getPrompt()), new GridBagConstraints(0,
		0, 1, 1, 0, 0, GridBagConstraints.NORTHEAST,
		GridBagConstraints.VERTICAL, new Insets(10, 10, 15, 5), 0, 0));

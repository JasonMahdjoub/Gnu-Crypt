...
import gnu.vm.jgnux.security.auth.callback.UnsupportedCallbackException;
...
public abstract class AbstractCallbackHandler implements CallbackHandler
{
     ...
     *             if no security provider is found to offer an implementation
     *             of <code>CallbackHandler</code> of the designated
     *             <code>type</code>.
     */
	...
	StringBuilder sb = new StringBuilder("CallbackHandler of type [")
		.append(type).append("] from provider[").append(provider)
		.append("] could not be created");
	Throwable cause;
	try
	{
	    return (CallbackHandler) Engine.getInstance(SERVICE, type,
		    provider);
	}
	...
	messages = ResourceBundle
		.getBundle("gnu/javax/security/auth/callback/MessagesBundle");
	this.name = name;
    }

...
public final class Password extends ExpirableObject
{
     ...
     *
     * @param password
     *            The byte array password to associate with this Password
     *            object.
     */
     ...
     * @param length
     *            The number of bytes, beginning at <i>offset</i>, to be copied
     ...
     * @param length
     *            The number of bytes, beginning at <i>offset</i>, to be copied
     *            into this object's {@link bPassword} field.
     * @param delay
	...
	if (offset < 0 || length < 0 || offset + length > password.length)
	    throw new ArrayIndexOutOfBoundsException("off=" + offset
		    + " length=" + length + " array.length=" + password.length);
     ...
     *            object.
     * @param offset
     *            The <i>password</i> character array parameter element marking
     *            the beginning of the contained password string.
     * @param length
     *            The number of characters, beginning at <i>offset</i>, to be
     *            copied into this object's {@link password} field.
     */
    ...
    /**
     * Sets password field char[], and byte[] array elements to zero. This
     * method implements base class {@link ExpirableObject} abstract method,
	...
	if (mIsDestroyed)
	    throw new IllegalStateException(
		    "Attempted destroyed password access.");

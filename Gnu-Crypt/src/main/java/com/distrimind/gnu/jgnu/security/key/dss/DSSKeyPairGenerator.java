...
package com.distrimind.gnu.jgnu.security.key.dss;
...
import com.distrimind.gnu.jgnu.security.hash.Sha160;
...
public class DSSKeyPairGenerator implements IKeyPairGenerator {
	 ...
	 */
	public static final String MODULUS_LENGTH = "com.distrimind.gnu.crypto.dss.L";

	/**
	 * Property name of the Boolean indicating wether or not to use default pre-
	 * computed values of <code>p</code>, <code>q</code> and <code>g</code> for a
	 * given modulus length. The ultimate behaviour of this generator with regard to
	 * using pre-computed parameter sets will depend on the value of this property
	 * and of the following one {@link #STRICT_DEFAULTS}:
	 * <ol>
	 * <li>If this property is {@link Boolean#FALSE} then this generator will accept
	 * being setup for generating parameters for any modulus length provided the
	 * modulus length is between <code>512</code> and <code>1024</code>, and is of
	 * the form <code>512 + 64 * n</code>. In addition, a new paramter set will
	 * always be generated; i.e. no pre- computed values are used.</li>
	 ...
	 * will only accept being setup for generating parameters for modulus lengths of
	 * <code>512</code>, <code>768</code> and <code>1024</code>. Any other value, of
	 * the modulus length, even if between <code>512</code> and <code>1024</code>,
	 * and of the form <code>512 + 64 * n</code>, will cause an
	 * {@link IllegalArgumentException} to be thrown. When those modulus length
	 * (<code>512</code>, <code>768</code>, and <code>1024</code>) are specified,
	 * the paramter set is always the same.</li>
	 ...
	 * behave as in point 1 above, except that it will use pre-computed values when
	 * possible; i.e. the modulus length is one of <code>512</code>,
	 * <code>768</code>, or <code>1024</code>.</li>
	 * </ol>
	 * The default value of this property is {@link Boolean#TRUE}.
	 */
	public static final String USE_DEFAULTS = "com.distrimind.gnu.crypto.dss.use.defaults";
	 ...
	 * computed defaults (value {@link Boolean#FALSE}), or throw an exception (value
	 * {@link Boolean#TRUE}) -- the exception in this case is an
	 * {@link IllegalArgumentException}. The default value for this property is
	 * {@link Boolean#FALSE}. The ultimate behaviour of this generator will depend
	 * on the values of this and {@link #USE_DEFAULTS} properties -- see
	 * {@link #USE_DEFAULTS} for more information.
	 */
	public static final String STRICT_DEFAULTS = "com.distrimind.gnu.crypto.dss.strict.defaults";

	/**
	 * Property name of an optional {@link SecureRandom} instance to use. The
	 * default is to use a classloader singleton from {@link PRNG}.
	 */
	public static final String SOURCE_OF_RANDOMNESS = "com.distrimind.gnu.crypto.dss.prng";
	 ...
	 * The default is to generate these values or use pre-computed ones, depending
	 * on the value of the <code>USE_DEFAULTS</code> attribute.
	 */
	public static final String DSS_PARAMETERS = "com.distrimind.gnu.crypto.dss.params";
	 ...
	 */
	public static final String PREFERRED_ENCODING_FORMAT = "com.distrimind.gnu.crypto.dss.encoding";
	...
	public static final DSAParameterSpec KEY_PARAMS_512 = new DSAParameterSpec(
			...
			new BigInteger("678471b27a9cf44ee91a49c5147db1a9aaf244f05a434d6486931d2d14271b9e"
	...
	public static final DSAParameterSpec KEY_PARAMS_768 = new DSAParameterSpec(
			...
			new BigInteger("30470ad5a005fb14ce2d9dcd87e38bc7d1b1c5facbaecbe95f190aa7a31d23c4"
	 ...
	 *                if the designated MODULUS_LENGTH value is not greater than
	 *                512, less than 1024 and not of the form
	 *                <code>512 + 64j</code>.
	 */
	@Override
			...
			default:
				if (strictDefaults.equals(Boolean.TRUE))
					throw new IllegalArgumentException(
							"Does not provide default parameters for " + L + "-bit modulus length");
				else {
					p = null;
					q = null;
					g = null;

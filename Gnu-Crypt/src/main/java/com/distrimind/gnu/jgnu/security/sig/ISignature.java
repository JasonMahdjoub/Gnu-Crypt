...
package com.distrimind.gnu.jgnu.security.sig;
...
public interface ISignature extends Cloneable {
	...
	public static final String VERIFIER_KEY = "com.distrimind.gnu.crypto.sig.public.key";

	/** Property name of the signer's private key. */
	public static final String SIGNER_KEY = "com.distrimind.gnu.crypto.sig.private.key";

	/**
	 * Property name of an optional {@link com.distrimind.gnu.vm.jgnu.security.SecureRandom},
	 * {@link java.util.Random}, or {@link com.distrimind.gnu.jgnu.security.prng.IRandom} instance
	 * to use. The default is to use a classloader singleton from
	 * {@link com.distrimind.gnu.jgnu.security.util.PRNG}.
	 */
	public static final String SOURCE_OF_RANDOMNESS = "com.distrimind.gnu.crypto.sig.prng";
	 ...
	 *             if the designated private key is not appropriate for this
	 *             signature scheme.
	 * @see #SOURCE_OF_RANDOMNESS
	 * @see #SIGNER_KEY
	 */
	void setupSign(Map<String, ?> attributes) throws IllegalArgumentException;
	 ...
	 *            the attributes to use for setting up this instance.
	 * @throws IllegalArgumentException
	 *             if the designated public key is not appropriate for this
	 *             signature scheme.
	 * @see #SOURCE_OF_RANDOMNESS
	 * @see #VERIFIER_KEY
	 */
	void setupVerify(Map<String, ?> attributes) throws IllegalArgumentException;
	 ...
	 *             if this instance was not setup for signature generation.
	 */
	 ...
	 * @throws IllegalStateException
	 *             if this instance was not setup for signature
	 ...
	 *
	 * @param buffer
	 *            the byte sequence to consider.
	 * @param offset
	 *            the byte poisition in <code>buffer</code> of the first byte to
	 *            consider.
	 * @param length
	 *            the number of bytes in <code>buffer</code> starting from the byte
	 *            at index <code>offset</code> to digest.
	 * @throws IllegalStateException
	 *             if this instance was not setup for signature
	 *             generation/verification.
	 */
	void update(byte[] buffer, int offset, int length) throws IllegalStateException;
	 ...
	 *
	 * @param signature
	 *            a native signature object previously generated by an invocation of
	 *            the <code>sign()</code> method.
	 * @return <code>true</code> iff the outpout of the verification phase confirms
	 *         that the designated signature object has been generated using the
	 *         corresponding public key of the recepient.
	 * @throws IllegalStateException
	 *             if this instance was not setup for signature verification.
	 */

...
public interface IMessageDigest extends Cloneable {
	...
	/**
	 * A basic test. Ensures that the digest of a pre-determined message is equal to
	...
	/**
	 * Continues a message digest operation, by filling the buffer, processing data
	 * in the algorithm's HASH_SIZE-bit block(s), updating the context and count,

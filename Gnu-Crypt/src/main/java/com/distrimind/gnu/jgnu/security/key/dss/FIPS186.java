...
public class FIPS186 {
	 ...
	 * <code>g</code> parameters only when <code>L</code> (the modulus length) is
	 * not one of the following: <code>512</code>, <code>768</code> and
	 ...
	 * <p>
	 * The DSS requires two primes , <code>p</code> and <code>q</code>, satisfying
	 * the following three conditions:
	 * <ul>
	 * <li><code>2<sup>159</sup> &lt; q &lt; 2<sup>160</sup></code></li>
	 * <li><code>2<sup>L-1</sup> &lt; p &lt; 2<sup>L</sup></code> for a specified
	 * <code>L</code>, where <code>L = 512 + 64j</code> for some
	 * <code>0 &lt;= j &lt;= 8</code></li>
	 * <li>q divides p - 1.</li>
	 * </ul>
	 * The algorithm used to find these primes is as described in FIPS-186, section
	 * 2.2: GENERATION OF PRIMES. This prime generation scheme starts by using the
	 * {@link Sha160} and a user supplied <i>SEED</i> to construct a prime,
	 * <code>q</code>, in the range 2<sup>159</sup> &lt; q &lt; 2<sup>160</sup>.
	 * Once this is accomplished, the same <i>SEED</i> value is used to construct an
	 * <code>X</code> in the range <code>2<sup>L-1
	 * </sup> &lt; X &lt; 2<sup>L</sup>. The prime, <code>p</code>, is then formed
	 * by rounding <code>X</code> to a number congruent to <code>1 mod
	 * 2q</code>. In this implementation we use the same <i>SEED</i> value given in
	 * FIPS-186, Appendix 5.
	 */

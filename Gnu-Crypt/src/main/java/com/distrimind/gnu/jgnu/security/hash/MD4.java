 ...
 * <p>
 * MD4 was the precursor to the stronger {@link com.distrimind.gnu.jgnu.security.hash.MD5}
 * algorithm, and while not considered cryptograpically secure itself, MD4 is in
 * use in various applications. It is slightly faster than MD5.
 * <p>
 * References:
 * <ol>
...
public class MD4 extends BaseHash {
	...
	/**
	 * Public constructor. Initializes the chaining variables, sets the byte count
	 * to <code>0</code>, and creates a new block of <code>512</code> bits.
	 */
	public MD4() {
	...
	protected byte[] getResult() {
		return new byte[] { (byte) a, (byte) (a >>> 8), (byte) (a >>> 16), (byte) (a >>> 24), (byte) b,
				(byte) (b >>> 8), (byte) (b >>> 16), (byte) (b >>> 24), (byte) c, (byte) (c >>> 8), (byte) (c >>> 16),
				(byte) (c >>> 24), (byte) d, (byte) (d >>> 8), (byte) (d >>> 16), (byte) (d >>> 24) };
	}

...
import com.distrimind.gnu.vm.jgnu.security.interfaces.RSAKey;
...
public class EME_PKCS1_V1_5 {
	 ...
	 * <code>PS</code> consisting of nonzero octets and a message <code>M</code> as:
	 * 
	 * <pre>
	 *     EM = 0x00 || 0x02 || PS || 0x00 || M.
	 * </pre>
	 ...
	 * value <code>0x00</code> to separate <code>PS</code> from <code>M</code>, or
	 * if the length of <code>PS</code> is less than <code>8</code> octets, output
	 ...
	 *             if the length of the designated entity <code>EM</code> is
	 *             different than <code>k</code> (the length in bytes of the public
	 *             shared modulus), or if any of the conditions described above is
	 *             detected.
	 */
	 ...
	 * <p>
	 * The method then concatenates <code>PS</code>, the message <code>M</code>, and
	 * other padding to form an encoded message <code>EM</code> of length
	 ...
	 *            the message to encode.
	 * @param irnd
	 *            the {@link IRandom} instance to use as a source of randomness.
	 * @return the encoded message <code>EM</code>.
	 */
	 ...
	 *            the message to encode.
	 * @param rnd
	 *            the {@link Random} instance to use as a source of randomness.
	 * @return the encoded message <code>EM</code>.
	 */

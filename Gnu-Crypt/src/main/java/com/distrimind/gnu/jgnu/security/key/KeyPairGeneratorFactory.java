...
import com.distrimind.gnu.jgnu.security.key.rsa.RSAKeyPairGenerator;
...
public class KeyPairGeneratorFactory {
	...
	public static IKeyPairGenerator getInstance(String name) {
		...
		if (name.equalsIgnoreCase(Registry.DSA_KPG) || name.equalsIgnoreCase(Registry.DSS_KPG))
			...
			result = makeInstance("com.distrimind.gnu.javax.crypto.key.dh.GnuDHKeyPairGenerator");
		else if (name.equalsIgnoreCase(Registry.SRP_KPG))
			result = makeInstance("com.distrimind.gnu.javax.crypto.key.srp6.SRPKeyPairGenerator");

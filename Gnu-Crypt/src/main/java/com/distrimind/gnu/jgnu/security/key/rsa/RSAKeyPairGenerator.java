...
public class RSAKeyPairGenerator implements IKeyPairGenerator {
	...
	public static final String MODULUS_LENGTH = "com.distrimind.gnu.crypto.rsa.L";

	/**
	 * Property name of an optional {@link SecureRandom} instance to use. The
	 * default is to use a classloader singleton from {@link PRNG}.
	 */
	public static final String SOURCE_OF_RANDOMNESS = "com.distrimind.gnu.crypto.rsa.prng";

	/**
	 * Property name of an optional {@link RSAKeyGenParameterSpec} instance to use
	 * for this generator's <code>n</code>, and <code>e</code> values. The default
	 * is to generate <code>n</code> and use a fixed value for <code>e</.code>
	 * (Fermat's F4 number).
	 */
	public static final String RSA_PARAMETERS = "com.distrimind.gnu.crypto.rsa.params";
	 ...
	 */
	public static final String PREFERRED_ENCODING_FORMAT = "com.distrimind.gnu.crypto.rsa.encoding";
	...
	public KeyPair generate() {
		...
		step1: while (true) {
			...
			if (p.compareTo(lower) >= 0 && p.compareTo(upper) <= 0 && p.isProbablePrime(80) && p.gcd(e).equals(ONE))
				break step1;
		}
	 ...
	 *                if the designated MODULUS_LENGTH value is less than 1024.
	 */
	@Override

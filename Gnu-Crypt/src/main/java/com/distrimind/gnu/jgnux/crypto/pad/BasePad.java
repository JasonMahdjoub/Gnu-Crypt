...
package com.distrimind.gnu.jgnux.crypto.pad;
...
public abstract class BasePad implements IPad {
	 ...
	 * Furthermore, and unless overridden, the default implementation will throw an
	 * {@link UnsupportedOperationException}. Concrete padding algorithms MUST
	...
	/**
	 * If any additional checks or resource setup must be done by the subclass, then
	 * this is the hook for it. This method will be called before the
	 ...
	 * @return <code>true</code> if the test passes; <code>false</code> otherwise.
	 */

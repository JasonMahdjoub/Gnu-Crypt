...
public class Serpent extends BaseCipher {
	private class Key implements Cloneable {
		int k0, k1, k2, k3, k4, k5, k6, k7, k8, k9, k10, k11, k12, k13, k14, k15, k16, k17, k18, k19, k20, k21, k22,
				k23, k24, k25, k26, k27, k28, k29, k30, k31, k32, k33, k34, k35, k36, k37, k38, k39, k40, k41, k42, k43,
				k44, k45, k46, k47, k48, k49, k50, k51, k52, k53, k54, k55, k56, k57, k58, k59, k60, k61, k62, k63, k64,
				k65, k66, k67, k68, k69, k70, k71, k72, k73, k74, k75, k76, k77, k78, k79, k80, k81, k82, k83, k84, k85,
				k86, k87, k88, k89, k90, k91, k92, k93, k94, k95, k96, k97, k98, k99, k100, k101, k102, k103, k104,
				k105, k106, k107, k108, k109, k110, k111, k112, k113, k114, k115, k116, k117, k118, k119, k120, k121,
				k122, k123, k124, k125, k126, k127, k128, k129, k130, k131;
	...
	public synchronized void decrypt(byte[] in, int i, byte[] out, int o, Object K, int bs) {
		Key key = (Key) K;
		x0 = (in[i] & 0xff) | (in[i + 1] & 0xff) << 8 | (in[i + 2] & 0xff) << 16 | (in[i + 3] & 0xff) << 24;
		x1 = (in[i + 4] & 0xff) | (in[i + 5] & 0xff) << 8 | (in[i + 6] & 0xff) << 16 | (in[i + 7] & 0xff) << 24;
		x2 = (in[i + 8] & 0xff) | (in[i + 9] & 0xff) << 8 | (in[i + 10] & 0xff) << 16 | (in[i + 11] & 0xff) << 24;
		x3 = (in[i + 12] & 0xff) | (in[i + 13] & 0xff) << 8 | (in[i + 14] & 0xff) << 16 | (in[i + 15] & 0xff) << 24;
		x0 ^= key.k128;
		x1 ^= key.k129;
		x2 ^= key.k130;
		x3 ^= key.k131;

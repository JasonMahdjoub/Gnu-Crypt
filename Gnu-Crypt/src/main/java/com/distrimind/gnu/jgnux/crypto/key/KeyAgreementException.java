...
public class KeyAgreementException extends KeyManagementException implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 296668670175465053L;

	/** @serial The possibly <code>null</code> <i>root</i> cause exception. */
	private Throwable cause = null;

	/**
	 * Constructs a new instance of <code>KeyAgreementException</code>. The root
	 ...
	 * a <i>root</i> exception; the stack trace of the <i>root</i> exception is also
	 ...
	 * and if it has a <i>root</i> exception, the string representation of the root
	 * exception. This string representation is meant for debugging and is not meant

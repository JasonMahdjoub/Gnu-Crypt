...
package com.distrimind.gnu.jgnux.crypto.jce.mac;

import com.distrimind.gnu.jgnu.security.Registry;
import com.distrimind.gnu.jgnux.crypto.jce.spec.UMac32ParameterSpec;
import com.distrimind.gnu.jgnux.crypto.mac.UMac32;
...
public final class UMac32Spi extends MacAdapter {
	...
	protected void engineInit(Key key, AlgorithmParameterSpec params)
		...
		if (params != null)
			attributes.put(UMac32.NONCE_MATERIAL, ((UMac32ParameterSpec) params).getNonce());
		try {

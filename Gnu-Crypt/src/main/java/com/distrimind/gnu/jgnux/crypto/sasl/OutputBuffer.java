...
public class OutputBuffer {
	...
	/**
	 * Encodes a SASL scalar quantity, <code>count</code>-octet long, to the current
	 * buffer.
	 *
	 * @param count
	 *            number of octets to encode <code>b</code> with.
	 * @param b
	 *            the scalar quantity.
	 * @throws SaslEncodingException
	 *             if an encoding size constraint is violated.
	 ...
	 *             if an encoding size constraint is violated.
	 * @throws SaslEncodingException
	 *             if the UTF-8 encoding is not supported on this platform.
	 * @throws IOException
	 *             if any other I/O exception occurs during the operation.
	 */

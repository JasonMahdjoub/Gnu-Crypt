...
import com.distrimind.gnu.jgnux.crypto.mac.HMacFactory;
...
public class PRNGFactory implements Registry {
	...
	public static IRandom getInstance(String prng) {
		...
		return com.distrimind.gnu.jgnu.security.prng.PRNGFactory.getInstance(prng);
	}
	...
	public static Set<String> getNames() {
		HashSet<String> hs = new HashSet<>(com.distrimind.gnu.jgnu.security.prng.PRNGFactory.getNames());
		hs.add(ICM_PRNG);
		hs.add(UMAC_PRNG);

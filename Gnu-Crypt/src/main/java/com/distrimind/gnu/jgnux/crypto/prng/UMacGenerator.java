 ...
 * "http://www.ietf.org/internet-drafts/draft-krovetz-umac-01.txt">UMAC</A>
 ...
 * (initialisation parameter <code>com.distrimind.gnu.crypto.prng.umac.kdf.index</code> taken
 ...
 * <code>com.distrimind.gnu.crypto.prng.umac.cipher.name</code> taken to be an instance of
 ...
 * <code>com.distrimind.gnu.crypto.cipher.block.size</code> (taken to be a instance of
...
public class UMacGenerator extends BasePRNG implements Cloneable {
	 ...
	 */
	public static final String INDEX = "com.distrimind.gnu.crypto.prng.umac.index";

	/** The name of the underlying symmetric key block cipher algorithm. */
	public static final String CIPHER = "com.distrimind.gnu.crypto.prng.umac.cipher.name";

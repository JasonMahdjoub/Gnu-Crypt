 ...
 * <ul>
 * <li>The block size in which to operate this block cipher instance. This value
 * is <b>optional</b>, if unspecified, the block cipher's default block size
 * shall be used.</li>
 ...
 * such an operation <b>DOES NOT</b> clone any session key material that may
 * have been used in initialising the source cipher (the instance to be cloned).
 * Instead a clone of an already initialised cipher is another instance that
...
public interface IBlockCipher extends Cloneable {
	 ...
	 */
	String CIPHER_BLOCK_SIZE = "com.distrimind.gnu.crypto.cipher.block.size";

	/**
	 * Property name of the user-supplied key material. The value associated to this
	 * property name is taken to be a byte array.
	 */
	String KEY_MATERIAL = "com.distrimind.gnu.crypto.cipher.key.material";

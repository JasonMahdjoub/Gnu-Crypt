 ...
 * (initialisation parameter <code>com.distrimind.gnu.crypto.prng.icm.cipher.name</code> taken
 ...
 * parameter <code>com.distrimind.gnu.crypto.cipher.block.size</code> (taken to be a instance
 ...
 * <ol>
 * <li><a href=
 * "http://www.ietf.org/internet-drafts/draft-mcgrew-saag-icm-00.txt"> Integer
...
public class ICMGenerator extends BasePRNG implements Cloneable {
	...
	public static final String CIPHER = "com.distrimind.gnu.crypto.prng.icm.cipher.name";

	/** Property name of ICM's block index length. */
	public static final String BLOCK_INDEX_LENGTH = "com.distrimind.gnu.crypto.prng.icm.block.index.length";

	/** Property name of ICM's segment index length. */
	public static final String SEGMENT_INDEX_LENGTH = "com.distrimind.gnu.crypto.prng.icm.segment.index.length";

	/** Property name of ICM's offset. */
	public static final String OFFSET = "com.distrimind.gnu.crypto.prng.icm.offset";

	/** Property name of ICM's segment index. */
	public static final String SEGMENT_INDEX = "com.distrimind.gnu.crypto.prng.icm.segment.index";
	...
	public void setup(Map<Object, ?> attributes) {
		...
		C0 = segmentNdx.multiply(TWO_FIFTY_SIX.pow(blockNdxLength)).add(r).modPow(BigInteger.ONE, counterRange);
		try {
			fillBlock();
		} catch (LimitReachedException impossible) {
			throw (InternalError) new InternalError().initCause(impossible);
		}
	}
}

 ...
 * <p>
 * A <i>MAC</i> provides a way to check the integrity of information transmitted
 * over, or stored in, an unreliable medium, based on a secret key. Typically,
 * <i>MAC</i>s are used between two parties, that share a common secret key, in
 * order to validate information transmitted between them.
 * <p>
 * When a <i>MAC</i> algorithm is based on a cryptographic hash function, it is
 * then called to a <i>HMAC</i> (Hashed Message Authentication Code) --see
 * <a href="http://www.ietf.org/rfc/rfc-2104.txt">RFC-2104</a>.
 * <p>
...
public interface IMac {
	 ...
	 */
	String MAC_KEY_MATERIAL = "com.distrimind.gnu.crypto.mac.key.material";
	 ...
	 * </pre>
	 */
	String TRUNCATED_SIZE = "com.distrimind.gnu.crypto.mac.truncated.size";

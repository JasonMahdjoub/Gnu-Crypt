...
import com.distrimind.gnu.jgnux.crypto.mac.MacOutputStream;
...
public final class AuthenticatedEntry extends MaskableEnvelopeEntry implements Registry {
	...
	/**
	 * Computes the mac over this envelope's data. This method <b>must</b> be called
	 * before this entry in encoded.
	 *
	 * @param key

...
package com.distrimind.gnu.jgnux.crypto.jce.prng;
...
import com.distrimind.gnu.jgnux.crypto.prng.ICMGenerator;
...
public class ICMRandomSpi extends SecureRandomSpi {
	...
	/*
	 * private static final String RETRY = "Retry..."; private static final String
	 * LIMIT_REACHED_MSG = "Limit reached: "; private static final String RESEED =
	 * "Re-seed...";
	 */

...
public class GnuDHPublicKey extends GnuDHKey implements DHPublicKey {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4915269619966521858L;
	...
	/**
	 * Constructs a new instance of <code>GnuDHPublicKey</code> given the designated
	 * parameters.
	 *
	...
	public GnuDHPublicKey(int preferredFormat, BigInteger q, BigInteger p, BigInteger g, BigInteger y) {
		super(preferredFormat == Registry.ASN1_ENCODING_ID ? Registry.X509_ENCODING_ID : preferredFormat, q, p, g);
		this.y = y;
	}

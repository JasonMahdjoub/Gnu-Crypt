...
public class Assembly {
	public static final String DIRECTION = "com.distrimind.gnu.crypto.assembly.assembly.direction";
	...
	/**
	 * Adds the designated {@link Transformer} and signals that it should operate in
	 * post-processing mode; i.e. it should apply its internal transformation
	 * algorithm on the input data stream, <b>after</b> it passes that stream to the
	 * next element in the <i>chain</i>.
	 *
	 * @param t
	 *            the {@link Transformer} to add at the head of the current chain.
	 * @throws IllegalArgumentException
	 *             if the designated {@link Transformer} has a non-null tail; i.e.
	 *             it is already an element of a chain.
	 */
	...
	/**
	 * Adds the designated {@link Transformer} and signals that it should operate in
	 * pre-processing mode; i.e. it should apply its internal transformation
	...
	/**
	 * Convenience method that calls the method with same name and three arguments.
	 * All bytes in <code>in</code>, starting from index position <code>0</code> are
	 * considered.
	 *
	 * @param in

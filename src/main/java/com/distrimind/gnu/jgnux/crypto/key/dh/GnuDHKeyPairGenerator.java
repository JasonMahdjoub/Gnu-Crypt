...
public class GnuDHKeyPairGenerator implements IKeyPairGenerator {
	 ...
	 */
	public static final String SOURCE_OF_RANDOMNESS = "com.distrimind.gnu.crypto.dh.prng";

	/**
	 * Property name of an optional {@link DHGenParameterSpec} or
	 * {@link DHParameterSpec} instance to use for this generator.
	 */
	public static final String DH_PARAMETERS = "com.distrimind.gnu.crypto.dh.params";

	/** Property name of the size in bits (Integer) of the public prime (p). */
	public static final String PRIME_SIZE = "com.distrimind.gnu.crypto.dh.L";

	/**
	 * Property name of the size in bits (Integer) of the private exponent (x).
	 */
	public static final String EXPONENT_SIZE = "com.distrimind.gnu.crypto.dh.m";
	 ...
	 */
	public static final String PREFERRED_ENCODING_FORMAT = "com.distrimind.gnu.crypto.dh.encoding";

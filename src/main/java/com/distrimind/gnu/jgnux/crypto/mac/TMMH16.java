 ...
 * <p>
 * The parameter <code>MAX_HASH_LENGTH</code>, which denotes the maximum value
 * which <code>MESSAGE_LENGTH</code> may take, is equal to
 * <code>KEY_LENGTH - TAG_LENGTH</code>.
 * <p>
 * References:
 * <ol>
 * <li><a href=
 * "http://www.ietf.org/internet-drafts/draft-mcgrew-saag-tmmh-01.txt"> The
 * Truncated Multi-Modular Hash Function (TMMH)</a>, David A. McGrew.</li>
 * </ol>
 */
public class TMMH16 extends BaseMac implements Cloneable {
	public static final String TAG_LENGTH = "com.distrimind.gnu.crypto.mac.tmmh.tag.length";

	public static final String KEYSTREAM = "com.distrimind.gnu.crypto.mac.tmmh.keystream";

	public static final String PREFIX = "com.distrimind.gnu.crypto.mac.tmmh.prefix";

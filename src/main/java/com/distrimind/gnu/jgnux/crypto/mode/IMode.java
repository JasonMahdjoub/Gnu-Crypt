...
public interface IMode extends IBlockCipher {
	 ...
	 */
	String STATE = "com.distrimind.gnu.crypto.mode.state";
	 ...
	 */
	String MODE_BLOCK_SIZE = "com.distrimind.gnu.crypto.mode.block.size";
	 ...
	 */
	String IV = "com.distrimind.gnu.crypto.mode.iv";

...
public class RFC2631 {
	...
	public BigInteger[] generateParameters() {
		...
		// start by genrating p and q, where q is of length m and p is of length
		// L
		...
		algorithm: while (true) {
			step4: while (true) {
				...
				// 5. Form q from U by computing U mod (2^m) and setting the
				// most
				...
				// 6. Use a robust primality algorithm to test whether q is
				// prime.

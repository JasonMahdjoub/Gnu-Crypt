...
public interface IKeyAgreementParty {
	 ...
	 *             if the key agreement is not yet initialised, or is initialised
	 ...
	 */
	void init(Map<String, Object> attributes) throws KeyAgreementException;

	/**
	 * Returns <code>true</code> if the party in the key agreement protocol exchange
	 * has completed its part of the exchange. If this is the case an
	 ...
	 * @return an outgoing message, or <code>null</code> if this is an intermediary
	 *         step that does not cause any output.
	 * @throws KeyAgreementException
	 *             if an exception occurs during the processing of the incoming
	 *             message, or during the generation of the outgoing message.
	 */

...
public class SRPKeyPairGenerator implements IKeyPairGenerator {
	 ...
	 */
	public static final String MODULUS_LENGTH = "com.distrimind.gnu.crypto.srp.L";

	/**
	 * Property name of the Boolean indicating wether or not to use defaults.
	 */
	public static final String USE_DEFAULTS = "com.distrimind.gnu.crypto.srp.use.defaults";

	/** Property name of the modulus (N) of an SRP key. */
	public static final String SHARED_MODULUS = "com.distrimind.gnu.crypto.srp.N";

	/** Property name of the generator (g) of an SRP key. */
	public static final String GENERATOR = "com.distrimind.gnu.crypto.srp.g";

	/** Property name of the user's verifier (v) for a Server SRP key. */
	public static final String USER_VERIFIER = "com.distrimind.gnu.crypto.srp.v";

	/**
	 * Property name of an optional {@link SecureRandom} instance to use. The
	 * default is to use a classloader singleton from {@link PRNG}.
	 */
	public static final String SOURCE_OF_RANDOMNESS = "com.distrimind.gnu.crypto.srp.prng";

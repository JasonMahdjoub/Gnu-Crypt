 ...
 * <ul>
 * <li>An appropriate prime p and generator g of Z<sub>p</sub><sup>*</sup> (2
 * &lt;= g &lt;= p-2) are selected and published.</li>
 ...
 * <li>A chooses a random secret x, 1 &lt;= x &lt;= p-2, and sends B message (1)
 * which is g^x mod p.</li>
 * <li>B chooses a random secret y, 1 &lt;= y &lt;= p-2, and sends A message (2)
 * which is g^y mod p.</li>
...
public abstract class DiffieHellmanKeyAgreement extends BaseKeyAgreementParty {
	public static final String SOURCE_OF_RANDOMNESS = "com.distrimind.gnu.crypto.dh.ka.prng";

	public static final String KA_DIFFIE_HELLMAN_OWNER_PRIVATE_KEY = "com.distrimind.gnu.crypto.dh.ka.owner.private.key";

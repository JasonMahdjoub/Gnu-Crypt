 ...
 * <p>
 * To authenticate a message, <code>Msg</code>, one first applies the universal
 * hash function, resulting in a string which is typically much shorter than the
 * original message. The pseudorandom function is applied to a nonce, and the
 * result is used in the manner of a Vernam cipher: the authentication tag is
 * the xor of the output from the hash function and the output from the
 * pseudorandom function. Thus, an authentication tag is generated as
 * 
 * <pre>
...
public class UMac32 extends BaseMac {
	 ...
	 */
	public static final String NONCE_MATERIAL = "com.distrimind.gnu.crypto.umac.nonce.material";

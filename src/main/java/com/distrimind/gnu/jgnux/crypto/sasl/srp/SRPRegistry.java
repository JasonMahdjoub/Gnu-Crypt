...
/**
 * A list of key names designating the values exchanged between the server and
 * client in an SRP communication authentication phase.
 */
public interface SRPRegistry {
	...
	String[] SRP_ALGORITHMS = { Registry.SHA160_HASH, // the default one
			Registry.MD5_HASH, Registry.RIPEMD128_HASH, Registry.RIPEMD160_HASH,

			Registry.SHA256_HASH, Registry.SHA384_HASH, Registry.SHA512_HASH };

	/**
	 * The name of the default message digest algorithm to use when no name is
	 * explicitely given. In this implementation it is the <b>first</b> among those
	 * supported; i.e. the algorithm at index position #0: SHA with 160-bit output.
	 */
	String SRP_DEFAULT_DIGEST_NAME = SRP_ALGORITHMS[0];

	/**
	 * The property name of the message digest algorithm name to use in a given SRP
	 * incarnation.
	 */
	...
	String SRP_HASH = "com.distrimind.gnu.crypto.sasl.srp.hash";

	/** Name of SRP mandatory service property. */
	String SRP_MANDATORY = "com.distrimind.gnu.crypto.sasl.srp.mandatory";

	/** Name of SRP replay detection property. */
	String SRP_REPLAY_DETECTION = "com.distrimind.gnu.crypto.sasl.srp.replay.detection";

	/** Name of SRP integrity protection property. */
	String SRP_INTEGRITY_PROTECTION = "com.distrimind.gnu.crypto.sasl.srp.integrity";

	/** Name of SRP confidentiality protection property. */
	String SRP_CONFIDENTIALITY = "com.distrimind.gnu.crypto.sasl.srp.confidentiality";

	/** Name of the main SRP password file pathname property. */
	String PASSWORD_FILE = "com.distrimind.gnu.crypto.sasl.srp.password.file";

	/**
	 * Name of the SRP password database property --a reference to
	 * {@link PasswordFile} object.
	 */
	String PASSWORD_DB = "com.distrimind.gnu.crypto.sasl.srp.password.db";

...
package com.distrimind.gnu.jgnux.security.auth.callback;
...
import com.distrimind.gnu.vm.jgnux.security.auth.callback.Callback;
import com.distrimind.gnu.vm.jgnux.security.auth.callback.ChoiceCallback;
import com.distrimind.gnu.vm.jgnux.security.auth.callback.ConfirmationCallback;
import com.distrimind.gnu.vm.jgnux.security.auth.callback.LanguageCallback;
import com.distrimind.gnu.vm.jgnux.security.auth.callback.NameCallback;
import com.distrimind.gnu.vm.jgnux.security.auth.callback.PasswordCallback;
import com.distrimind.gnu.vm.jgnux.security.auth.callback.TextInputCallback;
import com.distrimind.gnu.vm.jgnux.security.auth.callback.TextOutputCallback;
...
public class SwingCallbackHandler extends AbstractCallbackHandler {
	...
	protected void handleChoice(final ChoiceCallback callback) {
		...
		content.add(prompt, new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 5, 5));

		String[] choices = callback.getChoices();
		final JList<String> choicesList = new JList<>(choices);
		JScrollPane choicesPane = new JScrollPane(choicesList, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
				ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		final int defaultChoice = callback.getDefaultChoice();
		choicesList.setSelectedIndex(defaultChoice);
		choicesList.setSelectionMode(callback.allowMultipleSelections() ? ListSelectionModel.MULTIPLE_INTERVAL_SELECTION
				: ListSelectionModel.SINGLE_SELECTION);
		content.add(choicesPane, new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 10, 0, 10), 5, 5));
		...
		content.add(confirmButtons, new GridBagConstraints(0, 2, 1, 1, 0, 0, GridBagConstraints.EAST,
...

	{
		...
		if (prompt != null) {
			content.add(new JLabel(prompt), new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.WEST,
					GridBagConstraints.NONE, new Insets(5, 5, 5, 25), 0, 0));
		}
		...
		content.add(buttons, new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1, 1,
				GridBagConstraints.SOUTHEAST, GridBagConstraints.BOTH, new Insets(5, 5, 5, 5), 0, 0));
		dialog.setResizable(false);
		dialog.pack();
		dialog.setVisible(true);
		waitForInput(dialog, callback);
...

	{
		...
		for (int i = 0; i < locales.length; i++) {
			...
			/*
			 * if (locales[i].equals (locale)) defaultIndex = i;
			 */
		}
		locales[0] = locale;
		...
		ChoiceCallback cb = new ChoiceCallback(messages.getString("callback.language"), localeNames, 0, false);
		handleChoice(cb);
...

	{
		...
		content.add(new JLabel(callback.getPrompt()), new GridBagConstraints(0, 0, 1, 1, 0, 0,
				GridBagConstraints.NORTHEAST, GridBagConstraints.VERTICAL, new Insets(10, 10, 15, 5), 0, 0));
		...
		if ((_name = callback.getDefaultName()) != null)
			name.setText(_name);
		content.add(name, new GridBagConstraints(1, 0, 1, 1, 1, 1, GridBagConstraints.NORTHWEST,
				GridBagConstraints.BOTH, new Insets(10, 5, 15, 10), 0, 0));
		...
		okay.addActionListener(listener);
		buttons.add(okay);
		content.add(buttons, new GridBagConstraints(0, 1, 2, 1, 0, 0, GridBagConstraints.SOUTHEAST,
...

	{
		...
		content.add(password, new GridBagConstraints(1, 0, 1, 1, 1, 1, GridBagConstraints.NORTHWEST,
				GridBagConstraints.BOTH, new Insets(10, 5, 15, 10), 0, 0));
...

	{
		...
		content.add(new JLabel(callback.getPrompt()), new GridBagConstraints(0, 0, 1, 1, 0, 0,
				GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(10, 10, 15, 5), 0, 0));
		...
		JScrollPane textPane = new JScrollPane(text, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
				ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		content.add(textPane, new GridBagConstraints(0, 1, 1, 1, 1, 1, GridBagConstraints.CENTER,
		...
		okay.addActionListener(listener);
		buttons.add(okay);
		content.add(buttons, new GridBagConstraints(0, 2, 1, 1, 0, 0, GridBagConstraints.SOUTHEAST,
				GridBagConstraints.NONE, new Insets(0, 10, 10, 10), 0, 0));
...

	{
		...
		JScrollPane textPane = new JScrollPane(text, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
				ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		content.add(textPane, new GridBagConstraints(0, 0, 1, 1, 1, 1, GridBagConstraints.CENTER,
		...
		okay.setActionCommand("okay");
		okay.addActionListener(listener);
		content.add(okay, new GridBagConstraints(0, 1, 1, 1, 0, 0, GridBagConstraints.SOUTHEAST,
				GridBagConstraints.NONE, new Insets(0, 10, 10, 10), 0, 0));

...
import com.distrimind.gnu.vm.jgnux.security.auth.callback.UnsupportedCallbackException;
...
public abstract class AbstractCallbackHandler implements CallbackHandler {
	 ...
	 *             if no security provider is found to offer an implementation of
	 *             <code>CallbackHandler</code> of the designated <code>type</code>.
	 */
	...
	public static CallbackHandler getInstance(String type, Provider provider) throws NoSuchAlgorithmException {
		StringBuilder sb = new StringBuilder("CallbackHandler of type [").append(type).append("] from provider[")
	...
	protected AbstractCallbackHandler(final String name) {
		super();
		messages = ResourceBundle.getBundle("com/distrimind/gnu/javax/security/auth/callback/MessagesBundle");
		this.name = name;
	}

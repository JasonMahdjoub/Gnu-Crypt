...
public class Haval extends BaseHash {
	...
	/**
	 * Constructs a <code>Haval</code> instance with the designated output size (in
	 * bytes). Valid output <code>size</code> values are <code>16</code>,
	 * <code>20</code>, <code>24</code>, <code>28</code> and <code>32</code>. Valid
	 * values for <code>rounds</code> are in the range <code>3..5</code> inclusive.
	 *
	 * @param size
	 *            the output size in bytes of this instance.
	 * @param rounds
	...
	public Haval(int size, int rounds) {
		...
		if (size != HAVAL_128_BIT && size != HAVAL_160_BIT && size != HAVAL_192_BIT && size != HAVAL_224_BIT
				&& size != HAVAL_256_BIT)
	 ...
	 *
	 * rounds = 3: 6 5 4 3 2 1 0 | | | | | | | (replaced by) phi_{3,1}: 1 0 3 5 6 2
	 * 4 phi_{3,2}: 4 2 1 0 5 3 6 phi_{3,3}: 6 1 2 3 4 5 0
	 *
	 * rounds = 4: 6 5 4 3 2 1 0 | | | | | | | (replaced by) phi_{4,1}: 2 6 1 4 5 3
	 * 0 phi_{4,2}: 3 5 2 0 1 6 4 phi_{4,3}: 1 4 3 6 0 2 5 phi_{4,4}: 6 4 0 5 2 1 3
	 *
	 * rounds = 5: 6 5 4 3 2 1 0 | | | | | | | (replaced by) phi_{5,1}: 3 4 1 0 5 2
	 * 6 phi_{5,2}: 6 2 1 0 3 4 5 phi_{5,3}: 2 6 0 4 3 1 5 phi_{5,4}: 1 5 3 2 0 4 6

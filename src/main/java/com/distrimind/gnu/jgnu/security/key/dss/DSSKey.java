...
import com.distrimind.gnu.vm.jgnu.security.interfaces.DSAKey;
 ...
 * <p>
 * According to the JDK, cryptographic <i>Keys</i> all have a <i>format</i>. The
 * format used in this implementation is called <i>Raw</i>, and basically
 ...
 * relevant <code>getEncoded()</code> methods of each of the private and public
 * keys.
 * <p>
...
public abstract class DSSKey implements Key, DSAKey {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3708817210177907517L;
	 ...
	 * @param p
	 *            the DSS parameter <code>p</code>.
	 * @param q
	 *            the DSS parameter <code>q</code>.
	 * @param g
	 *            the DSS parameter <code>g</code>.
	 */
	 ...
	 * <i>inherited</i>. This may be the case when the key is re-constructed from an
	 * X.509 certificate with absent or NULL AlgorithmIdentifier's parameters field.
	 *
	 * @param obj
	...
	public boolean equals(Object obj) {
		...
		return p.equals(that.getParams().getP()) && q.equals(that.getParams().getQ())
	 ...
	 *         <code>g</code> are all <code>null</code>. Returns <code>false</code>
	 *         otherwise.
	 */
	...
	public String toString() {
		if (str == null) {
			...
			if (hasInheritedParameters())
				...
				sb.append("p=0x").append(p.toString(16)).append(",").append(ls).append("q=0x").append(q.toString(16))
						.append(",").append(ls).append("g=0x").append(g.toString(16));
			str = sb.toString();
		}
		return str;
	}

...
package com.distrimind.gnu.jgnu.security.sig.dss;
...
import com.distrimind.gnu.jgnu.security.sig.BaseSignature;
import com.distrimind.gnu.jgnu.security.sig.ISignature;
 ...
 * <li>g: Where <code>g = h<sup>(p-1)</sup>/q mod p</code>, where <code>h</code>
 * is any integer with <code>1 &lt; h &lt; p - 1</code> such that
 * <code>h<sup> (p-1)</sup>/q mod p > 1</code> (<code>g</code> has order
 ...
 * </ol>
 * <p>
 * The integers <code>p</code>, <code>q</code>, and <code>g</code> can be public
 * and can be common to a group of users. A user's private and public keys are
 * <code>x</code> and <code>y</code>, respectively. They are normally fixed for
 * a period of time. Parameters <code>x</code> and <code>k</code> are used for
 * signature generation only, and must be kept secret. Parameter <code>k</code>
 ...
 * 180. For use in computing <code>s</code>, this string must be converted to an
 * integer.
 * <p>
 * As an option, one may wish to check if <code>r == 0</code> or <code>s == 0
 * </code>. If either <code>r == 0</code> or <code>s == 0</code>, a new value of

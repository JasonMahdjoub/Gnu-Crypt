...
public interface Registry {
	...
	String SHA160_HASH2 = "sha160";

	String SHA256_HASH2 = "sha256";

	String SHA384_HASH2 = "sha384";

	String SHA512_HASH2 = "sha512";
	...
	/**
	 * PRNG based on PBKDF2 from PKCS #5 v.2. This is suffixed with the name of a
	 * MAC to be used as a PRF.
	 */
	...
	String RAW_ENCODING = "com.distrimind.gnu.crypto.raw.format";

	String X509_ENCODING = "com.distrimind.gnu.crypto.x509.format";

	String PKCS8_ENCODING = "com.distrimind.gnu.crypto.pkcs8.format";

	String ASN1_ENCODING = "com.distrimind.gnu.crypto.asn1.format";
	...
	byte[] MAGIC_RAW_RSA_PKCS1V1_5_SIGNATURE = new byte[] { 0x47, RAW_ENCODING_ID, 0x52, 0x54 };
	...
	String SASL_PREFIX = "com.distrimind.gnu.crypto.sasl";

...
package com.distrimind.gnu.jgnu.security.prng;
 ...
 * <li>"5.8 Definition: A PRBG that passes the <em>next-bit test</em> (possibly
 * under some plausible but unproved mathematical assumption such as the
 * intractability of factoring integers) is called a <em>cryptographically
 ...
 * such an operation, for those algorithms that use an underlying symmetric key
 ...
 * Instead a clone of an already initialised PRNG, that uses an underlying
